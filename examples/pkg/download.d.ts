...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h3f6f3f97289b89fa: (a: number, b: number) => void;
  readonly closure3152_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure3430_externref_shim: (a: number, b: number, c: any, d: any) => void;
